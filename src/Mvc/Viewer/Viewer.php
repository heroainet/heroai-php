...
define('IN_TINY_VIEW_TEMPLATE', true);
...
class Viewer implements \ArrayAccess
{
    ...
    {
        return $this->_variables[$key] ? true : false;
    }
     ...
     * @return void exied
     */
    public function message($message, $url = null, $subject = null, $timeout = null)
    {
    ...
    {
        $sp = new Helper\SplitPage(array('url' => $url,'total' => $total,'size' => $size,'pageid' => $pageId,'color' => $color,'css' => $isOut
        ));
    ...
    protected function _getViewer($ename)
    {
        ...
        {
            throw new ViewerException('模板引擎对象"' . $ename . '"未注册');
        }
