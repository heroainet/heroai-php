...
class Data implements \ArrayAccess
{
    ...
    protected static $_driverMap = [
        'db' => 'ZeroAI\Data\Db\Db',
        'memcached' => 'ZeroAI\Data\Memcached\Memcached',
        'redis' => 'ZeroAI\Data\Redis\Redis'
    ];
    ...
    public function getData($id = NULL)
    {
        ...
        {
            throw new DataException(sprintf('获取Data实例错误:%s没有实现接口ZeroAI\Data\IDataSchema!', $className));
        }
