 ...
 */
namespace ZeroAI\Data\Db;

use ZeroAI\Data\IDataSchema;

/**
 * Db的结构类
 *
 * @package ZeroAI.Data.Db
...
class Db implements IDataSchema
{
    ...
    protected static $_driverMap = [
        'mysqli' => 'ZeroAI\Data\Db\Mysql\Mysqli',
        'mysql_pdo' => 'ZeroAI\Data\Db\Mysql\Pdo'
    ];
    ...
    protected function _getSchema()
    {
        ...
        {
            throw new DbException(sprintf('获取db.schema错误:%s没有实现接口ZeroAI\Data\Db\IDb', $className));
        }
        $this->_schema = $schema;
        return $schema;
    }
