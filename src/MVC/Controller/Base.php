 ...
 */
namespace ZeroAI\MVC\Controller;
 ...
 * 控制器积类
 *
 * @package ZeroAI.Application.Controller
...
abstract class Base
{
     ...
     * 当前应用程序的状态和配置数据
     *
     * @var \ZeroAI\Config\Configuration
     */
    public $properties;
     ...
     * 当前WEB请求参数
     *
     * @var \ZeroAI\MVC\Request\WebRequest
     */
    public $request;
     ...
     * 当前WEB请求响应实例
     *
     * @var \ZeroAI\MVC\Response\WebResponse
     */
    public $response;
     ...
     * @param $key string
     *        属性名
     * @return mixed view ZeroAI\MVC\Viewer\Viewer 视图层对象
     *         config ZeroAI\Config\Configuration 默认配置对象池
     *         cache ZeroAI\Cache\Cache 默认缓存对象池
     *         lang 语言对象
     *         *Model 尾缀为Model的模型对象
     */
