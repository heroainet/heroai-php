...
class Redis extends Base
{
     ...
     * @param string $key
     *        键
     * @return \ZeroAI\Data\Redis\Counter
     */
     ...
     * 创建一个队列对象
     *
     * @return \ZeroAI\Data\Redis\Queue
     */
     ...
     * 创建一个哈希表对象
     *
     * @return \ZeroAI\Data\Redis\HashTable
     */
    ...
    protected function _getSchema()
    {
        ...
        {
            throw new ModelException('Data.Redis.Schema实例加载失败，ID' . $this->_dataId . '不是ZeroAI\Data\Redis\Schema实例');
        }
        return $this->_schema;
    }
}
