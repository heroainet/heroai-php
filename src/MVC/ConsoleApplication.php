...
use ZeroAI\MVC\Response\ConsoleResponse;
use ZeroAI\MVC\Request\ConsoleRequest;
use ZeroAI\Console\Worker\IWorkerHandler;
use ZeroAI\Console\IDaemonHandler;

/**
 * 命令行应用实例
 *
 * @package ZeroAI.Application
...
class ConsoleApplication extends ApplicationBase implements IWorkerHandler, IDaemonHandler
{
     ...
     *
     * {@inheritdoc}
     * @see \ZeroAI\Console\Worker\IWorkerHandler::onWorkerDispatch()
     */
     ...
     *        权重级别
     * @see \ZeroAI\Console\IDaemonHandler::onOutLog
     */
     ...
     *
     * {@inheritdoc}
     * @see \ZeroAI\MVC\ApplicationBase::_initPlugin()
     */
    ...
    protected function _initPluginBuilder($config)
    {
        ...
        {
            $builderInstance = new \ZeroAI\MVC\Plugin\Builder($this);
        }
    ...
    protected function _initDaemonPlugin($config)
    {
        ...
        {
            $daemonInstance = new \ZeroAI\MVC\Plugin\Daemon($this);
        }
