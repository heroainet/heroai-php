 ...
 *
 */
namespace ZeroAI\Build;

/**
 * 打包实例
 *
 * @package ZeroAI.Build
...
class Builder
{
    ...
    public function run()
    {
        $name = $this->_config['name'] ?: 'zeroaid';
    ...
    protected function _addFrameWork()
    {
        ...
        $this->_addDir($fwpath, 'zeroai-framework');
    }
    ...
    protected function _createrPharFile()
    {
        ...
        */
        ...
        require(ZEROAI_PHAR_FILE . '/zeroai-framework/ZeroAI.php');
        \ZeroAI\Runtime\Runtime::getInstance();
        \ZeroAI\Build\Builder::init([]);
        \ZeroAI\ZeroAI::createApplication(APPLICATION_PATH, $profilestr)->run();
        ?>
        EOT;
