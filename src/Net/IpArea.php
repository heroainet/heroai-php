...
class IpArea
{
	...
	*/
	 ...
	 * @return string/null
	 */
	private static function _get($ip)
	{
		$return = '';
	 ...
	 * 根据域名获取地区
	 * 
	 * @param $domain string 域名 不带HTTP://
	 * @return string
	 */
	private static function _getByDomain($domain)
	{
	 ...
	 * 根据IP获取城市名
	 * 
	 * @param $ip string 输出IP
	 * @return string
	 */
	private static function _getCity($ip)
	{
	 ...
	 * @return string/null
	 */
	private static function _getIpAreaByQQWry($ip)
	{
